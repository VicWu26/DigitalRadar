function [Rx] = channel8(Tx_each, antenna_gain, space_cube, space_i, space_j, space_k, Tx_num, Rx_num, code_length, chip_rate, carrier_freq)
    %% -------------------initial-------------------------
    %% antenna structure
    derad = pi/180;     % 角度轉弧度
    Tx_d = 3.5 : 0.5 :(Tx_num+6)*0.5; % 0 ~ 0.5 
